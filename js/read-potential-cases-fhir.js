...
(async () => {
  ...
  await fs.writeFile("asthma-clinicals-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("asthma-clinicals-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
